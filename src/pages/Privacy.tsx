  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-green max-w-none text-gray-600">
        ...
        <p className="mb-4">
          At Cookuu, we take your privacy seriously. This Privacy Policy
        ...
        <p className="mb-4">
          ...
          experience possible. This may include:
        </p>
        ...
        <p className="mb-4">
          ...
          measures to protect your personal data. We do not sell your personal
